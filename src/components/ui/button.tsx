...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-[var(--accent-app)] text-[var(--accent-app-ink)] shadow-[0_6px_20px_hsl(20_60%_30%/0.30)] hover:-translate-y-px hover:brightness-110 light:shadow-[0_6px_16px_hsl(24_70%_50%/0.20)]",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/85",
        outline:
          "border border-border bg-card hover:border-[var(--accent-app)] hover:bg-muted hover:text-foreground",
        secondary:
