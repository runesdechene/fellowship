...
/** Liste complète des avis exposants, en modale DA. */
export function ReviewListModal({ reviews, onClose }: Props) {
  return (
    <div className="review-list-overlay" onClick={onClose}>
      <div className="review-list-modal" onClick={(e) => e.stopPropagation()}>
        <div className="review-list-head">
          <h2><Star strokeWidth={1.8} /> {reviews.length} avis exposant{reviews.length > 1 ? 's' : ''}</h2>
