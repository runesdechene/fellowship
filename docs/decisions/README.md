...
- [0007 — DA V2 « Parchemin »](0007-da-v2-parchemin.md) (2026-08-11) — **nouvelle direction artistique** : parchemin **clair par défaut** (aucune bascule auto), encre brune, typo graisse 500 à interlettrage négatif, **blocs séparés par la teinte et non par le trait**, seules les images ont des bords, halos à 17 %, accent terracotta ; livraison **V2 commutable sur main** + [maquette app](assets/v2-app-clair.html) · [comparateur landing](assets/v2-landing-parchemin.html) · [calque CSS](assets/landing-parchemin.css)
- [0006 — Le virage annuaire : Fellowship, l'homme du milieu](0006-virage-annuaire-homme-du-milieu.md) (2026-08-11) — **pivot de positionnement** : l'annuaire public d'opportunités d'exposition devient la porte d'entrée (exposants **et** orgas) ; niche **professionnelle, pas thématique** ; gratuit exposant / **facturation orga aux dossiers validés** ; 4 principes (égoïsme utile, toucher le réel, 2 formes de social, valeur au jour 1) ; fossé = **le graphe accumulé**
